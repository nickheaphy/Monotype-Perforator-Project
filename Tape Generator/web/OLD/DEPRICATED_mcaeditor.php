...
<body>
    <main>
        ...
        <div class="container">
            ...
            <div class="mb-3 start-50">
                ...
                <button type="button" class="btn btn-primary" id="savemca" disabled
                <?php
                    if (!(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true)) {
                        echo " disabled";
                ...
                <div class="modal-content">
                    ...
                    <form>
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="character" autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="special" id="specialnormal" checked>
                                    <label class="form-check-label" for="specialnormal">
                                        Normal
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="special" id="specialjspace">
                                    <label class="form-check-label" for="specialjspace">
                                        J-Space
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="special" id="specialquad">
                                    <label class="form-check-label" for="specialquad">
                                        Quad
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="special" id="specialblank">
                    ...
                    <button type="button" class="btn btn-primary" id="matrixSaveButton"
                    <?php
                    if (!(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true)) {
                        echo " disabled";
                    } else if ($mode != "edit" && $mode != "new") {
            ...
            <div class="modal fade" id="unitModal" tabindex="-1" aria-labelledby="unitModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" id="unitSaveButton"
                    <?php
    ...
    <script src="js/mcaeditor_el.js"></script>
